 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ecx_dcsync0(mut context: *mut ecx_contextt,
                                     mut slave: uint16, mut act: boolean,
                                     mut CyclTime: uint32,
                                     mut CyclShift: int32) {
    let mut h: uint8 = 0;
    let mut RA: uint8 = 0;
    ...
    RA = 0 as libc::c_int as uint8;
    /* stop cyclic operation, ready for next trigger */
    ecx_FPWR((*context).port, slaveh,
             ECT_REG_DCSYNCACT as libc::c_int as uint16,
             ::core::mem::size_of::<uint8>() as libc::c_ulong as uint16,
             &mut RA as *mut uint8 as *mut libc::c_void, 2000 as libc::c_int);
    if act != 0 {
        RA = (1 as libc::c_int + 2 as libc::c_int) as uint8
        /* act cyclic operation and sync0, sync1 deactivated */
    } /* write access to ethercat */
    h = 0 as libc::c_int as uint8; /* read local time of slave */
    ecx_FPWR((*context).port, slaveh, ECT_REG_DCCUC as libc::c_int as uint16,
             ::core::mem::size_of::<uint8>() as libc::c_ulong as uint16,
             &mut h as *mut uint8 as *mut libc::c_void, 2000 as libc::c_int);
    t1 = 0 as libc::c_int as int64;
    ecx_FPRD((*context).port, slaveh,
             ECT_REG_DCSYSTIME as libc::c_int as uint16,
             ::core::mem::size_of::<int64>() as libc::c_ulong as uint16,
             &mut t1 as *mut int64 as *mut libc::c_void, 2000 as libc::c_int);
    t1 = t1;
   ...
   will sync at the same moment (you can use CyclShift to shift the sync) */
    if CyclTime > 0 as libc::c_int as libc::c_uint {
        t =
            (t1 + 100000000 as libc::c_int as libc::c_long) /
                CyclTime as libc::c_long * CyclTime as libc::c_long +
                CyclTime as libc::c_long + CyclShift as libc::c_long
    } else {
        t =
            t1 + 100000000 as libc::c_int as libc::c_long +
    ...
    ecx_FPWR((*context).port, slaveh,
             ECT_REG_DCSTART0 as libc::c_int as uint16,
             ::core::mem::size_of::<int64>() as libc::c_ulong as uint16,
             &mut t as *mut int64 as *mut libc::c_void,
             2000 as libc::c_int); /* activate cyclic operation */
    tc = CyclTime as int32;
    ecx_FPWR((*context).port, slaveh,
             ECT_REG_DCCYCLE0 as libc::c_int as uint16,
             ::core::mem::size_of::<int32>() as libc::c_ulong as uint16,
             &mut tc as *mut int32 as *mut libc::c_void, 2000 as libc::c_int);
    ecx_FPWR((*context).port, slaveh,
             ECT_REG_DCSYNCACT as libc::c_int as uint16,
             ::core::mem::size_of::<uint8>() as libc::c_ulong as uint16,
             &mut RA as *mut uint8 as *mut libc::c_void, 2000 as libc::c_int);
    ...
    (*(*context).slavelist.offset(slave as isize)).DCcycle =
        CyclTime as int32;
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ecx_dcsync01(mut context: *mut ecx_contextt,
                                      mut slave: uint16, mut act: boolean,
    ...
    TrueCyclTime =
        CyclTime1.wrapping_div(CyclTime0).wrapping_add(1 as libc::c_int as
                                                           libc::c_uint).wrapping_mul(CyclTime0);
    slaveh = (*(*context).slavelist.offset(slave as isize)).configadr;
    RA = 0 as libc::c_int as uint8;
    /* stop cyclic operation, ready for next trigger */
    ecx_FPWR((*context).port, slaveh,
             ...
             &mut RA as *mut uint8 as *mut libc::c_void, 2000 as libc::c_int);
    if act != 0 {
        RA = (1 as libc::c_int + 2 as libc::c_int + 4 as libc::c_int) as uint8
   ...
   This insures best synchronization between slaves, slaves with the same CyclTime
   will sync at the same moment (you can use CyclShift to shift the sync) */
    if CyclTime0 > 0 as libc::c_int as libc::c_uint {
        t =
            (t1 + 100000000 as libc::c_int as libc::c_long) /
                TrueCyclTime as libc::c_long * TrueCyclTime as libc::c_long +
                TrueCyclTime as libc::c_long + CyclShift as libc::c_long
    } else {
        t =
            t1 + 100000000 as libc::c_int as libc::c_long +
                CyclShift as libc::c_long
    ...
    ecx_FPWR((*context).port, slaveh,
             ...
             ::core::mem::size_of::<int64>() as libc::c_ulong as uint16,
             &mut t as *mut int64 as *mut libc::c_void,
             2000 as libc::c_int); /* SYNC1 cycle time */
    ...
    ecx_FPWR((*context).port, slaveh,
             ECT_REG_DCCYCLE1 as libc::c_int as uint16,
             ::core::mem::size_of::<int32>() as libc::c_ulong as uint16,
             &mut tc as *mut int32 as *mut libc::c_void, 2000 as libc::c_int);
    ecx_FPWR((*context).port, slaveh,
             ECT_REG_DCSYNCACT as libc::c_int as uint16,
...
unsafe extern "C" fn ecx_porttime(mut context: *mut ecx_contextt,
 ...
 -> int32 {
    ...
    match port as libc::c_int {
        ...
        _ => { ts = 0 as libc::c_int }
    }
    return ts;
}
/* calculate previous active port of a slave */
unsafe extern "C" fn ecx_prevport(mut context: *mut ecx_contextt,
                                  mut slave: uint16, mut port: uint8)
 -> uint8 {
    let mut pport: uint8 = port;
    let mut aport: uint8 =
        (*(*context).slavelist.offset(slave as isize)).activeports;
    match port as libc::c_int {
        0 => {
            if aport as libc::c_int & 0x4 as libc::c_int != 0 {
                pport = 2 as libc::c_int as uint8
            } else if aport as libc::c_int & 0x2 as libc::c_int != 0 {
                pport = 1 as libc::c_int as uint8
            } else if aport as libc::c_int & 0x8 as libc::c_int != 0 {
                pport = 3 as libc::c_int as uint8
            }
        }
        1 => {
            if aport as libc::c_int & 0x8 as libc::c_int != 0 {
                pport = 3 as libc::c_int as uint8
            } else if aport as libc::c_int & 0x1 as libc::c_int != 0 {
                pport = 0 as libc::c_int as uint8
            } else if aport as libc::c_int & 0x4 as libc::c_int != 0 {
                pport = 2 as libc::c_int as uint8
            }
        }
        2 => {
            if aport as libc::c_int & 0x2 as libc::c_int != 0 {
                pport = 1 as libc::c_int as uint8
            } else if aport as libc::c_int & 0x8 as libc::c_int != 0 {
                pport = 3 as libc::c_int as uint8
            } else if aport as libc::c_int & 0x1 as libc::c_int != 0 {
        ...
        3 => {
            if aport as libc::c_int & 0x1 as libc::c_int != 0 {
                pport = 0 as libc::c_int as uint8
            } else if aport as libc::c_int & 0x4 as libc::c_int != 0 {
                pport = 2 as libc::c_int as uint8
            } else if aport as libc::c_int & 0x2 as libc::c_int != 0 {
...
unsafe extern "C" fn ecx_parentport(mut context: *mut ecx_contextt,
                                    mut parent: uint16) -> uint8 {
    let mut parentport: uint8 = 0 as libc::c_int as uint8;
    let mut b: uint8 = 0;
    /* search order is important, here 3 - 1 - 2 - 0 */
    b = (*(*context).slavelist.offset(parent as isize)).consumedports;
    if b as libc::c_int & 0x8 as libc::c_int != 0 {
        parentport = 3 as libc::c_int as uint8;
        b =
            (b as libc::c_int & !(0x8 as libc::c_int) as uint8 as libc::c_int)
                as uint8
    } else if b as libc::c_int & 0x2 as libc::c_int != 0 {
        parentport = 1 as libc::c_int as uint8;
        b =
            (b as libc::c_int & !(0x2 as libc::c_int) as uint8 as libc::c_int)
                as uint8
    } else if b as libc::c_int & 0x4 as libc::c_int != 0 {
        parentport = 2 as libc::c_int as uint8;
        b =
            (b as libc::c_int & !(0x4 as libc::c_int) as uint8 as libc::c_int)
                as uint8
    } else if b as libc::c_int & 0x1 as libc::c_int != 0 {
        parentport = 0 as libc::c_int as uint8;
        b =
            (b as libc::c_int & !(0x1 as libc::c_int) as uint8 as libc::c_int)
                as uint8
    }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ecx_configdc(mut context: *mut ecx_contextt)
 -> boolean {
    let mut i: uint16 = 0; /* latch DCrecvTimeA of all slaves */
    let mut slaveh: uint16 =
        0; /* EtherCAT uses 2000-01-01 as epoch start instead of 1970-01-01 */
    let mut parent: uint16 = 0;
    let mut child: uint16 = 0;
    let mut parenthold: uint16 = 0 as libc::c_int as uint16;
    let mut prevDCslave: uint16 = 0 as libc::c_int as uint16;
    let mut ht: int32 = 0;
    let mut dt1: int32 = 0;
    let mut dt2: int32 = 0;
    let mut dt3: int32 = 0;
    ...
    (*(*context).slavelist.offset(0 as libc::c_int as isize)).hasdc =
        0 as libc::c_int as boolean;
    (*(*context).grouplist.offset(0 as libc::c_int as isize)).hasdc =
        0 as libc::c_int as boolean;
    ht = 0 as libc::c_int;
    ecx_BWR((*context).port, 0 as libc::c_int as uint16,
            ECT_REG_DCTIME0 as libc::c_int as uint16,
            ::core::mem::size_of::<int32>() as libc::c_ulong as uint16,
            &mut ht as *mut int32 as *mut libc::c_void, 2000 as libc::c_int);
    mastertime = osal_current_time();
    mastertime.sec =
        (mastertime.sec as
             libc::c_ulong).wrapping_sub(946684800 as libc::c_ulong) as uint32
            as uint32;
    mastertime64 =
        (mastertime.sec as
             uint64).wrapping_mul(1000000 as libc::c_int as
                                      libc::c_ulong).wrapping_add(mastertime.usec
                                                                      as
                                                                      uint64).wrapping_mul(1000
                                                                                               as
                                                                                               libc::c_int
                                                                                               as
                                                                                               libc::c_ulong);
    ...
    while i as libc::c_int <= *(*context).slavecount {
        ...
        if (*(*context).slavelist.offset(i as isize)).hasdc != 0 {
            if (*(*context).slavelist.offset(0 as libc::c_int as isize)).hasdc
                   == 0 {
                ...
                (*(*context).slavelist.offset(0 as libc::c_int as
                                                  isize)).DCnext = i;
                (*(*context).slavelist.offset(i as isize)).DCprevious =
                    0 as libc::c_int as uint16;
                (*(*context).grouplist.offset((*(*context).slavelist.offset(i
                                                                                as
                                                                                isize)).group
                                                  as isize)).hasdc =
                    1 as libc::c_int as boolean;
                ...
                (*(*context).slavelist.offset(prevDCslave as isize)).DCnext =
                    i;
                (*(*context).slavelist.offset(i as isize)).DCprevious =
                    prevDCslave
            }
            /* this branch has DC slave so remove parenthold */
            parenthold = 0 as libc::c_int as uint16;
            prevDCslave = i;
            slaveh = (*(*context).slavelist.offset(i as isize)).configadr;
            ecx_FPRD((*context).port, slaveh,
                     ECT_REG_DCTIME0 as libc::c_int as uint16,
                     ::core::mem::size_of::<int32>() as libc::c_ulong as
                         uint16, &mut ht as *mut int32 as *mut libc::c_void,
                     2000 as libc::c_int);
            (*(*context).slavelist.offset(i as isize)).DCrtA = ht;
            /* 64bit latched DCrecvTimeA of each specific slave */
            ecx_FPRD((*context).port, slaveh,
                     ECT_REG_DCSOF as libc::c_int as uint16,
                     ::core::mem::size_of::<int64>() as libc::c_ulong as
                         uint16, &mut hrt as *mut int64 as *mut libc::c_void,
                     2000 as libc::c_int);
            ...
            ecx_FPWR((*context).port, slaveh,
                     ECT_REG_DCSYSOFFSET as libc::c_int as uint16,
                     ::core::mem::size_of::<int64>() as libc::c_ulong as
                         uint16, &mut hrt as *mut int64 as *mut libc::c_void,
                     2000 as libc::c_int);
            ecx_FPRD((*context).port, slaveh,
                     ECT_REG_DCTIME1 as libc::c_int as uint16,
                     ::core::mem::size_of::<int32>() as libc::c_ulong as
                         uint16, &mut ht as *mut int32 as *mut libc::c_void,
                     2000 as libc::c_int);
            (*(*context).slavelist.offset(i as isize)).DCrtB = ht;
            ecx_FPRD((*context).port, slaveh,
                     ECT_REG_DCTIME2 as libc::c_int as uint16,
                     ::core::mem::size_of::<int32>() as libc::c_ulong as
                         uint16, &mut ht as *mut int32 as *mut libc::c_void,
                     2000 as libc::c_int);
            (*(*context).slavelist.offset(i as isize)).DCrtC = ht;
            ecx_FPRD((*context).port, slaveh,
                     ECT_REG_DCTIME3 as libc::c_int as uint16,
                     ::core::mem::size_of::<int32>() as libc::c_ulong as
                         uint16, &mut ht as *mut int32 as *mut libc::c_void,
                     2000 as libc::c_int);
            (*(*context).slavelist.offset(i as isize)).DCrtD = ht;
            /* make list of active ports and their time stamps */
            nlist = 0 as libc::c_int as int8;
            if (*(*context).slavelist.offset(i as isize)).activeports as
                   libc::c_int & 0x1 as libc::c_int != 0 {
                plist[nlist as usize] = 0 as libc::c_int as int8;
                tlist[nlist as usize] =
                    (*(*context).slavelist.offset(i as isize)).DCrtA;
                nlist += 1
            }
            if (*(*context).slavelist.offset(i as isize)).activeports as
                   libc::c_int & 0x8 as libc::c_int != 0 {
                plist[nlist as usize] = 3 as libc::c_int as int8;
                tlist[nlist as usize] =
                    (*(*context).slavelist.offset(i as isize)).DCrtD;
                nlist += 1
            }
            if (*(*context).slavelist.offset(i as isize)).activeports as
                   libc::c_int & 0x2 as libc::c_int != 0 {
                plist[nlist as usize] = 1 as libc::c_int as int8;
                tlist[nlist as usize] =
                    (*(*context).slavelist.offset(i as isize)).DCrtB;
                nlist += 1
            }
            if (*(*context).slavelist.offset(i as isize)).activeports as
                   libc::c_int & 0x4 as libc::c_int != 0 {
                plist[nlist as usize] = 2 as libc::c_int as int8;
                tlist[nlist as usize] =
                    (*(*context).slavelist.offset(i as isize)).DCrtC;
                nlist += 1
            }
            /* entryport is port with the lowest timestamp */
            entryport = 0 as libc::c_int as uint8;
            if nlist as libc::c_int > 1 as libc::c_int &&
                   tlist[1 as libc::c_int as usize] <
                       tlist[entryport as usize] {
                entryport = 1 as libc::c_int as uint8
            }
            if nlist as libc::c_int > 2 as libc::c_int &&
                   tlist[2 as libc::c_int as usize] <
                       tlist[entryport as usize] {
                entryport = 2 as libc::c_int as uint8
            }
            if nlist as libc::c_int > 3 as libc::c_int &&
                   tlist[3 as libc::c_int as usize] <
                       tlist[entryport as usize] {
                entryport = 3 as libc::c_int as uint8
            }
            ...
            *fresh0 =
                (*fresh0 as libc::c_int &
                     !((1 as libc::c_int) << entryport as libc::c_int) as
            ...
            loop  {
                child = parent;
                parent =
                    (*(*context).slavelist.offset(parent as isize)).parent;
                if parent as libc::c_int == 0 as libc::c_int ||
                       (*(*context).slavelist.offset(parent as isize)).hasdc
                           as libc::c_int != 0 {
                    break ;
                }
            }
            ...
            if parent as libc::c_int > 0 as libc::c_int {
                ...
                if (*(*context).slavelist.offset(parent as isize)).topology as
                       libc::c_int == 1 as libc::c_int {
                    (*(*context).slavelist.offset(i as isize)).parentport =
                        (*(*context).slavelist.offset(parent as
                                                          isize)).entryport
                }
                dt1 = 0 as libc::c_int;
                dt2 = 0 as libc::c_int;
                    ...
                    ecx_porttime(context, parent,
                        ...
                        ecx_porttime(context, parent,
                                     ecx_prevport(context, parent,
                                                  (*(*context).slavelist.offset(i
                                                                                    as
                                                                                    isize)).parentport));
                /* current slave has children */
            /* those children's delays need to be subtracted */
                if (*(*context).slavelist.offset(i as isize)).topology as
                       libc::c_int > 1 as libc::c_int {
                    dt1 =
                        ecx_porttime(context, i,
                                     ecx_prevport(context, i,
                                                  (*(*context).slavelist.offset(i
                                                                                    as
                                                                                    isize)).entryport))
                            -
            ...
            /* previous child's delays need to be added */
                if child as libc::c_int - parent as libc::c_int >
                       1 as libc::c_int {
                    dt2 =
                        ecx_porttime(context, parent,
                                     ecx_prevport(context, parent,
                            ...
                            -
                            ecx_porttime(context, parent,
                                         (*(*context).slavelist.offset(parent
                                                                           as
                                                                           isize)).entryport)
                }
                if dt2 < 0 as libc::c_int { dt2 = -dt2 }
                /* calculate current slave delay from delta times */
            /* assumption : forward delay equals return delay */
                (*(*context).slavelist.offset(i as isize)).pdelay =
                    (dt3 - dt1) / 2 as libc::c_int + dt2 +
                        (*(*context).slavelist.offset(parent as
                                                          isize)).pdelay;
                ht = (*(*context).slavelist.offset(i as isize)).pdelay;
                /* write propagation delay*/
                ecx_FPWR((*context).port, slaveh,
                         ECT_REG_DCSYSDELAY as libc::c_int as uint16,
                         ::core::mem::size_of::<int32>() as libc::c_ulong as
                             uint16,
    ...
    return (*(*context).slavelist.offset(0 as libc::c_int as isize)).hasdc;
}
#[no_mangle]
pub unsafe extern "C" fn ec_dcsync0(mut slave: uint16, mut act: boolean,
                                    mut CyclTime: uint32,
                                    mut CyclShift: int32) {
    ecx_dcsync0(&mut ecx_context, slave, act, CyclTime, CyclShift);
}
#[no_mangle]
pub unsafe extern "C" fn ec_dcsync01(mut slave: uint16, mut act: boolean,
                                     mut CyclTime0: uint32,
                                     mut CyclTime1: uint32,
                                     mut CyclShift: int32) {
    ecx_dcsync01(&mut ecx_context, slave, act, CyclTime0, CyclTime1,
                 CyclShift);
}
#[no_mangle]
