 ...
 * configurations. */
#[no_mangle]
pub static mut priMAC: [uint16; 3] =
    [0x101 as libc::c_int as uint16, 0x101 as libc::c_int as uint16,
     0x101 as libc::c_int as uint16];
/* * Secondary source MAC address used for EtherCAT. */
#[no_mangle]
pub static mut secMAC: [uint16; 3] =
    [0x404 as libc::c_int as uint16, 0x404 as libc::c_int as uint16,
     0x404 as libc::c_int as uint16];
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ecx_setupnic(mut port: *mut ecx_portt,
 ...
 -> libc::c_int {
              ...
              ifr_ifru:
                  C2RustUnnamed_0{ifru_addr:
                                      sockaddr{sa_family: 0,
                                               sa_data: [0; 14],},},};
    let mut sll: sockaddr_ll =
        sockaddr_ll{sll_family: 0,
                    sll_protocol: 0,
                    sll_ifindex: 0,
                    sll_hatype: 0,
                    sll_pkttype: 0,
    ...
    let mut mutexattr: pthread_mutexattr_t =
    ...
    if secondary != 0 {
        ...
        if !(*port).redport.is_null() {
            ...
            *psock = -(1 as libc::c_int);
            (*port).redstate = ECT_RED_DOUBLE as libc::c_int;
            (*(*port).redport).stack.sock =
                &mut (*(*port).redport).sockhandle;
            (*(*port).redport).stack.txbuf = &mut (*port).txbuf;
            (*(*port).redport).stack.txbuflength = &mut (*port).txbuflength;
            (*(*port).redport).stack.tempbuf =
                &mut (*(*port).redport).tempinbuf;
            (*(*port).redport).stack.rxbuf = &mut (*(*port).redport).rxbuf;
            (*(*port).redport).stack.rxbufstat =
                &mut (*(*port).redport).rxbufstat;
            (*(*port).redport).stack.rxsa = &mut (*(*port).redport).rxsa;
            ecx_clear_rxbufstat(&mut *(*(*port).redport).rxbufstat.as_mut_ptr().offset(0
                                                                                           as
                                                                                           libc::c_int
                                                                                           as
                                                                                           isize));
        ...
        pthread_mutexattr_setprotocol(&mut mutexattr,
        ...
        (*port).sockhandle = -(1 as libc::c_int);
        (*port).lastidx = 0 as libc::c_int as uint8;
        ...
        ecx_clear_rxbufstat(&mut *(*port).rxbufstat.as_mut_ptr().offset(0 as
                                                                            libc::c_int
                                                                            as
                                                                            isize));
    ...
    *psock =
        socket(17 as libc::c_int, SOCK_RAW as libc::c_int,
               htons(0x88a4 as libc::c_int as uint16_t) as libc::c_int);
    timeout.tv_sec = 0 as libc::c_int as __time_t;
    timeout.tv_usec = 1 as libc::c_int as __suseconds_t;
    r =
        setsockopt(*psock, 1 as libc::c_int, 20 as libc::c_int,
                   &mut timeout as *mut timeval as *const libc::c_void,
                   ::core::mem::size_of::<timeval>() as libc::c_ulong as
                       socklen_t);
    r =
        setsockopt(*psock, 1 as libc::c_int, 21 as libc::c_int,
                   &mut timeout as *mut timeval as *const libc::c_void,
                   ::core::mem::size_of::<timeval>() as libc::c_ulong as
                       socklen_t);
    i = 1 as libc::c_int;
    r =
        setsockopt(*psock, 1 as libc::c_int, 5 as libc::c_int,
    ...
    r =
        ioctl(*psock, 0x8933 as libc::c_int as libc::c_ulong,
              &mut ifr as *mut ifreq);
    ifindex = ifr.ifr_ifru.ifru_ivalue;
    strcpy(ifr.ifr_ifrn.ifrn_name.as_mut_ptr(), ifname);
    ifr.ifr_ifru.ifru_flags = 0 as libc::c_int as libc::c_short;
    /* reset flags of NIC interface */
    r =
        ioctl(*psock, 0x8913 as libc::c_int as libc::c_ulong,
              &mut ifr as *mut ifreq);
    /* set flags of NIC interface, here promiscuous and broadcast */
    ifr.ifr_ifru.ifru_flags =
        (ifr.ifr_ifru.ifru_flags as libc::c_int | IFF_PROMISC as libc::c_int |
             IFF_BROADCAST as libc::c_int) as libc::c_short;
    r =
        ioctl(*psock, 0x8914 as libc::c_int as libc::c_ulong,
              &mut ifr as *mut ifreq);
    /* bind socket to protocol, in this case RAW EtherCAT */
    sll.sll_family = 17 as libc::c_int as libc::c_ushort;
    sll.sll_ifindex = ifindex;
    sll.sll_protocol = htons(0x88a4 as libc::c_int as uint16_t);
    r =
        bind(*psock, &mut sll as *mut sockaddr_ll as *mut sockaddr,
             ::core::mem::size_of::<sockaddr_ll>() as libc::c_ulong as
                 socklen_t);
    /* setup ethernet headers in tx buffers so we don't have to repeat it */
    i = 0 as libc::c_int;
    while i < 16 as libc::c_int {
        ec_setupheader(&mut *(*port).txbuf.as_mut_ptr().offset(i as isize) as
    ...
    if r == 0 as libc::c_int { rval = 1 as libc::c_int }
    return rval;
}
/* * Close sockets used
 * @param[in] port        = port context struct
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ecx_closenic(mut port: *mut ecx_portt)
 -> libc::c_int {
    if (*port).sockhandle >= 0 as libc::c_int { close((*port).sockhandle); }
    if !(*port).redport.is_null() &&
           (*(*port).redport).sockhandle >= 0 as libc::c_int {
...
pub unsafe extern "C" fn ec_setupheader(mut p: *mut libc::c_void) {
    ...
    (*bp).da0 = htons(0xffff as libc::c_int as uint16_t);
    (*bp).da1 = htons(0xffff as libc::c_int as uint16_t);
    (*bp).da2 = htons(0xffff as libc::c_int as uint16_t);
    (*bp).sa0 = htons(priMAC[0 as libc::c_int as usize]);
    (*bp).sa1 = htons(priMAC[1 as libc::c_int as usize]);
    (*bp).sa2 = htons(priMAC[2 as libc::c_int as usize]);
    (*bp).etype = htons(0x88a4 as libc::c_int as uint16_t);
}
...
pub unsafe extern "C" fn ecx_getindex(mut port: *mut ecx_portt) -> uint8 {
    ...
    idx = ((*port).lastidx as libc::c_int + 1 as libc::c_int) as uint8;
    /* index can't be larger than buffer array */
    if idx as libc::c_int >= 16 as libc::c_int {
        idx = 0 as libc::c_int as uint8
    }
    cnt = 0 as libc::c_int as uint8;
    /* try to find unused index */
    while (*port).rxbufstat[idx as usize] != EC_BUF_EMPTY as libc::c_int &&
              (cnt as libc::c_int) < 16 as libc::c_int {
    ...
    if (*port).redstate != ECT_RED_NONE as libc::c_int {
        (*(*port).redport).rxbufstat[idx as usize] =
            EC_BUF_ALLOC as libc::c_int
    }
    (*port).lastidx = idx;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ecx_setbufstat(mut port: *mut ecx_portt,
                                        mut idx: uint8,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ecx_outframe(mut port: *mut ecx_portt,
                                      mut idx: uint8,
 ...
 -> libc::c_int {
    ...
    } else { stack = &mut (*(*port).redport).stack }
    lp = (*(*stack).txbuflength)[idx as usize];
    (*(*stack).rxbufstat)[idx as usize] = EC_BUF_TX as libc::c_int;
    rval =
        send(*(*stack).sock,
             (*(*stack).txbuf)[idx as usize].as_mut_ptr() as
                 *const libc::c_void, lp as size_t, 0 as libc::c_int) as
            libc::c_int;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ecx_outframe_red(mut port: *mut ecx_portt,
                                          mut idx: uint8) -> libc::c_int {
    ...
    (*ehp).sa1 = htons(priMAC[1 as libc::c_int as usize]);
    /* transmit over primary socket*/
    rval = ecx_outframe(port, idx, 0 as libc::c_int);
    if (*port).redstate != ECT_RED_NONE as libc::c_int {
        pthread_mutex_lock(&mut (*port).tx_mutex);
        ehp = &mut (*port).txbuf2 as *mut ec_bufT as *mut ec_etherheadert;
        /* use dummy frame for secondary socket transmit (BRD) */
        datagramP =
            &mut *(*port).txbuf2.as_mut_ptr().offset(::core::mem::size_of::<ec_etherheadert>()
                                                         as libc::c_ulong as
                                                         isize) as *mut uint8
                as *mut ec_comt;
        ...
        (*ehp).sa1 = htons(secMAC[1 as libc::c_int as usize]);
        /* transmit over secondary socket */
        (*(*port).redport).rxbufstat[idx as usize] = EC_BUF_TX as libc::c_int;
        if send((*(*port).redport).sockhandle,
                &mut (*port).txbuf2 as *mut ec_bufT as *const libc::c_void,
                (*port).txbuflength2 as size_t, 0 as libc::c_int) ==
               -(1 as libc::c_int) as libc::c_long {
            (*(*port).redport).rxbufstat[idx as usize] =
                EC_BUF_EMPTY as libc::c_int
        }
 ...
 */
unsafe extern "C" fn ecx_recvpkt(mut port: *mut ecx_portt,
                                 mut stacknumber: libc::c_int)
 -> libc::c_int {
    let mut lp: libc::c_int = 0;
    ...
    lp = ::core::mem::size_of::<ec_bufT>() as libc::c_ulong as libc::c_int;
    bytesrx =
        recv(*(*stack).sock,
             (*(*stack).tempbuf).as_mut_ptr() as *mut libc::c_void,
             lp as size_t, 0 as libc::c_int) as libc::c_int;
    (*port).tempinbufs = bytesrx;
    return (bytesrx > 0 as libc::c_int) as libc::c_int;
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ecx_inframe(mut port: *mut ecx_portt, mut idx: uint8,
                                     mut stacknumber: libc::c_int)
 -> libc::c_int {
    let mut l: uint16 = 0;
    let mut rval: libc::c_int = 0;
    ...
    rxbuf =
        &mut *(*(*stack).rxbuf).as_mut_ptr().offset(idx as isize) as
            *mut ec_bufT;
    /* check if requested index is already in buffer ? */
    if (idx as libc::c_int) < 16 as libc::c_int &&
           (*(*stack).rxbufstat)[idx as usize] == EC_BUF_RCVD as libc::c_int {
        l =
            ((*rxbuf)[0 as libc::c_int as usize] as libc::c_int +
                 ((((*rxbuf)[1 as libc::c_int as usize] as libc::c_int &
                        0xf as libc::c_int) as uint16 as libc::c_int) <<
                      8 as libc::c_int)) as uint16;
        /* return WKC */
        rval =
            (*rxbuf)[l as usize] as libc::c_int +
                (((*rxbuf)[(l as libc::c_int + 1 as libc::c_int) as usize] as
                      uint16 as libc::c_int) << 8 as libc::c_int);
        /* mark as completed */
        ...
        if ecx_recvpkt(port, stacknumber) != 0 {
            ...
            if (*ehp).etype as libc::c_int ==
                   htons(0x88a4 as libc::c_int as uint16_t) as libc::c_int {
                ecp =
                    &mut *(*(*stack).tempbuf).as_mut_ptr().offset(::core::mem::size_of::<ec_etherheadert>()
                                                                      as
                                                                      libc::c_ulong
                                                                      as
                                                                      isize)
                ...
                if idxf as libc::c_int == idx as libc::c_int {
                    ...
                    memcpy(rxbuf as *mut libc::c_void,
                           ...
                           ((*(*stack).txbuflength)[idx as usize] as
                    ...
                    rval =
                        (*rxbuf)[l as usize] as libc::c_int +
                            (((*rxbuf)[(l as libc::c_int + 1 as libc::c_int)
                                           as usize] as uint16 as libc::c_int)
                                 << 8 as libc::c_int);
                    /* mark as completed */
                    (*(*stack).rxbufstat)[idx as usize] =
                        EC_BUF_COMPLETE as libc::c_int;
                    /* store MAC source word 1 for redundant routing info */
                    (*(*stack).rxsa)[idx as usize] =
                        ntohs((*ehp).sa1) as libc::c_int
                } else if (idxf as libc::c_int) < 16 as libc::c_int &&
                              (*(*stack).rxbufstat)[idxf as usize] ==
                                  EC_BUF_TX as libc::c_int {
                    rxbuf =
                        &mut *(*(*stack).rxbuf).as_mut_ptr().offset(idxf as
                                                                        isize)
                            as *mut ec_bufT;
                    ...
                    memcpy(rxbuf as *mut libc::c_void,
                           &mut *(*(*stack).tempbuf).as_mut_ptr().offset(::core::mem::size_of::<ec_etherheadert>()
                                                                             ...
                                                                             isize)
                               as *mut uint8 as *const libc::c_void,
                           ((*(*stack).txbuflength)[idxf as usize] as
                                libc::c_ulong).wrapping_sub(::core::mem::size_of::<ec_etherheadert>()
                                                                as
                                                                libc::c_ulong));
                    /* mark as received */
                    (*(*stack).rxbufstat)[idxf as usize] =
                        EC_BUF_RCVD as libc::c_int;
                    (*(*stack).rxsa)[idxf as usize] =
                        ntohs((*ehp).sa1) as libc::c_int
                }
            }
        }
 ...
 * EC_NOFRAME.
 */
unsafe extern "C" fn ecx_waitinframe_red(mut port: *mut ecx_portt,
                                         mut idx: uint8,
                                         mut timer: *mut osal_timert)
 -> libc::c_int {
    let mut timer2: osal_timert =
        osal_timert{stop_time: ec_timet{sec: 0, usec: 0,},};
    let mut wkc: libc::c_int = -(1 as libc::c_int);
    let mut wkc2: libc::c_int = -(1 as libc::c_int);
    let mut primrx: libc::c_int = 0;
    let mut secrx: libc::c_int = 0;
    /* if not in redundant mode then always assume secondary is OK */
    if (*port).redstate == ECT_RED_NONE as libc::c_int {
        wkc2 = 0 as libc::c_int
    }
    loop  {
        /* only read frame if not already in */
        if wkc <= -(1 as libc::c_int) {
            wkc = ecx_inframe(port, idx, 0 as libc::c_int)
        }
        ...
        if (*port).redstate != ECT_RED_NONE as libc::c_int {
            ...
            if wkc2 <= -(1 as libc::c_int) {
                wkc2 = ecx_inframe(port, idx, 1 as libc::c_int)
            }
        }
        if !((wkc <= -(1 as libc::c_int) || wkc2 <= -(1 as libc::c_int)) &&
                 osal_timer_is_expired(timer) == 0) {
            break ;
        }
    }
    ...
    if (*port).redstate != ECT_RED_NONE as libc::c_int {
        ...
        primrx = 0 as libc::c_int;
        if wkc > -(1 as libc::c_int) { primrx = (*port).rxsa[idx as usize] }
        /* secrx if the received MAC source on psecondary socket */
        secrx = 0 as libc::c_int;
        if wkc2 > -(1 as libc::c_int) {
            secrx = (*(*port).redport).rxsa[idx as usize]
        }
        /* primary socket got secondary frame and secondary socket got primary frame */
      /* normal situation in redundant mode */
        if primrx == secMAC[1 as libc::c_int as usize] as libc::c_int &&
               secrx == priMAC[1 as libc::c_int as usize] as libc::c_int {
            /* copy secondary buffer to primary */
            memcpy(&mut *(*port).rxbuf.as_mut_ptr().offset(idx as isize) as
                       *mut ec_bufT as *mut libc::c_void,
                   &mut *(*(*port).redport).rxbuf.as_mut_ptr().offset(idx as
                                                                          isize)
                       as *mut ec_bufT as *const libc::c_void,
                   ((*port).txbuflength[idx as usize] as
                        libc::c_ulong).wrapping_sub(::core::mem::size_of::<ec_etherheadert>()
                                                        as libc::c_ulong));
            wkc = wkc2
        }
      ...
      /* we need to resend TX packet */
        if primrx == 0 as libc::c_int &&
               secrx == secMAC[1 as libc::c_int as usize] as libc::c_int ||
               primrx == priMAC[1 as libc::c_int as usize] as libc::c_int &&
                   secrx == secMAC[1 as libc::c_int as usize] as libc::c_int {
            /* If both primary and secondary have partial connection retransmit the primary received
          * frame over the secondary socket. The result from the secondary received frame is a combined
          * frame that traversed all slaves in standard order. */
            if primrx == priMAC[1 as libc::c_int as usize] as libc::c_int &&
                   secrx == secMAC[1 as libc::c_int as usize] as libc::c_int {
                /* copy primary rx to tx buffer */
                memcpy(&mut *(*(*port).txbuf.as_mut_ptr().offset(idx as
                                                                     isize)).as_mut_ptr().offset(::core::mem::size_of::<ec_etherheadert>()
                                                                                                     as
                                                                                                     libc::c_ulong
                                                                                                     as
                                                                                                     isize)
            ...
            osal_timer_start(&mut timer2, 2000 as libc::c_int as uint32);
            /* resend secondary tx */
            ecx_outframe(port, idx, 1 as libc::c_int);
            loop  {
                /* retrieve frame */
                wkc2 = ecx_inframe(port, idx, 1 as libc::c_int);
                if !(wkc2 <= -(1 as libc::c_int) &&
                         osal_timer_is_expired(&mut timer2) == 0) {
                    break ;
                }
            }
            if wkc2 > -(1 as libc::c_int) {
                /* copy secondary result to primary rx buffer */
                memcpy(&mut *(*port).rxbuf.as_mut_ptr().offset(idx as isize)
                           as *mut ec_bufT as *mut libc::c_void,
                       &mut *(*(*port).redport).rxbuf.as_mut_ptr().offset(idx
                                                                              as
                                                                              isize)
                           as *mut ec_bufT as *const libc::c_void,
                       ((*port).txbuflength[idx as usize] as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ecx_waitinframe(mut port: *mut ecx_portt,
                                         mut idx: uint8,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ecx_srconfirm(mut port: *mut ecx_portt,
                                       mut idx: uint8,
                                       mut timeout: libc::c_int)
 -> libc::c_int {
    let mut wkc: libc::c_int = -(1 as libc::c_int);
    let mut timer1: osal_timert =
        osal_timert{stop_time: ec_timet{sec: 0, usec: 0,},};
    let mut timer2: osal_timert =
        osal_timert{stop_time: ec_timet{sec: 0, usec: 0,},};
    ...
    loop  {
        ...
        if !(wkc <= -(1 as libc::c_int) &&
                 osal_timer_is_expired(&mut timer1) == 0) {
            break ;
        }
    }
    return wkc;
...
#[no_mangle]
pub unsafe extern "C" fn ec_setupnic(mut ifname: *const libc::c_char,
                                     mut secondary: libc::c_int)
 -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ec_setbufstat(mut idx: uint8,
                                       mut bufstat: libc::c_int) {
    ecx_setbufstat(&mut ecx_port, idx, bufstat);
}
#[no_mangle]
pub unsafe extern "C" fn ec_outframe(mut idx: uint8,
                                     mut stacknumber: libc::c_int)
 -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ec_inframe(mut idx: uint8,
                                    mut stacknumber: libc::c_int)
 -> libc::c_int {
    return ecx_inframe(&mut ecx_port, idx, stacknumber);
}
#[no_mangle]
pub unsafe extern "C" fn ec_waitinframe(mut idx: uint8,
                                        mut timeout: libc::c_int)
 -> libc::c_int {
    return ecx_waitinframe(&mut ecx_port, idx, timeout);
}
#[no_mangle]
pub unsafe extern "C" fn ec_srconfirm(mut idx: uint8,
                                      mut timeout: libc::c_int)
 -> libc::c_int {
